...
export const AboutUs = lazy(
  () => import('Pages/Landing/Aboutus/Aboutus' /* webpackChunkName: "AboutUs section" */),
);
export const Events = lazy(
  () => import('Pages/Landing/Events' /* webpackChunkName: "Events_section" */),
);
export const Hero = lazy(() => import('Pages/Landing/Hero' /* webpackChunkName: "Hero" */));
export const LogosCarousel = lazy(
  () => import('Pages/Landing/LogosCarousel' /* webpackChunkName: "LogosCarousel" */),
);
...
export const Projects = lazy(
  () => import('Pages/Landing/Projects' /* webpackChunkName: "Projects_section" */),
);
...
export const Volunteers = lazy(
  () => import('Pages/Landing/Volunteers' /* webpackChunkName: "Volunteers section" */),
);
export const Divider = lazy(
  () => import('Pages/Landing/Divider/Divider' /* webpackChunkName: "Divider" */),
);
export const Courses = lazy(
  () => import('Pages/Landing/Courses' /* webpackChunkName: "Courses_section" */),
);
export const DonateForm = lazy(
  () => import('./Forms/DonateForm' /* webpackChunkName: "DonateForm" */),
);
