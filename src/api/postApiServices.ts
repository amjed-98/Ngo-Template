...
export const getStartDonationUrl = (ongId: string) =>
  `${BASE_URL}/api/private/ong/${ongId}/start-donation`;
export const getFinalizeDonationUrl = (ongId: string) =>
  `${BASE_URL}/api/private/ong/${ongId}/donations`;
...
export const getFinalizeCoursePaymentUrl = (courseId: string) =>
  `${BASE_URL}/api/private/buycourse/${courseId}/finablice`;
...
export const getBuyEventTicketUrl = (eventId: string) =>
  `${BASE_URL}/api/private/buyticket/${eventId}/start`;
