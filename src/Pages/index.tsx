...
export const ProjectDetails = lazy(
  () => import('./ProjectDetails' /* webpackChunkName: "ProjectDetails" */),
);
...
export const DonateForm = lazy(
  () => import('../components/Forms/DonateForm' /* webpackChunkName: "DonateForm" */),
);
export const ContactUsForm = lazy(
  () => import('../components/Forms/ContactUsForm' /* webpackChunkName: "Contactus" */),
);
export const SingleEvent = lazy(
  () => import('./EventDetails' /* webpackChunkName: "SingleEvent" */),
);
export const SingleProduct = lazy(
  () => import('./ProductDetails' /* webpackChunkName: "SingleProduct" */),
);
...
export const FinalizeDonationPage = lazy(
  () => import('./FinalizeDonation' /* webpackChunkName: "FinalizeDonation" */),
);
