...
export const PremiumEvent = lazy(() => import('Pages/Landing/PremiumEvent/PremiumEvent' /* webpackChunkName: "PremiumEventSection" */))
export const Projects = lazy(() => import('Pages/Landing/Projects' /* webpackChunkName: "Projects_section" */))
export const SocialImpact = lazy(() => import('Pages/Landing/SocialImpact' /* webpackChunkName: "SocialImpact_section" */))
export const SubscribeDivider = lazy(() => import('Pages/Landing/SubscribeDivider' /* webpackChunkName: "SubscribeDivider" */))
