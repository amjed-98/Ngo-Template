...
export const getProjectImagesURL = (projectId: string) =>
  `${BASE_URL}/api/private/projectimages/${projectId}`;
export const getProjectLatestDonationsURL = (causeId: string) =>
  `${BASE_URL}/api/private/comments/${causeId}`;
...
export const getCauseDonationsHistoryUrl = (causeId: string) =>
  `${BASE_URL}/api/private/comments/${causeId}`;
export const getPlatformConfigUrl = (ngoId: string) =>
  `${BASE_URL}/api/private/ongs/${ngoId}/all-platform-config`;
...
export const getEventImagesUrl = (eventId: string) =>
  `${BASE_URL}/api/private/eventimages/${eventId}`;
export const getTransparencyURL = (ongId: string) =>
  `${BASE_URL}/api/private/ongs/${ongId}/transparency`;
export const getCoursesURL = (ongId: string) => `${BASE_URL}/api/private/courses/ong/${ongId}`;
export const getBuyCourseUrl = (courseId: string) =>
  `${BASE_URL}/api/private/buycourse/${courseId}/start`;
